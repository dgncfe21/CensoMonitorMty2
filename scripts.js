...
var cars_Ref = firebase.database().ref('/LAMPARAS_E2vNte');


var dataConductores = firebase.database().ref('/LAMPARAS_E2vNte');
...
var pedidos_Ref = firebase.database().ref('/RPUMEDIDOR_E2vNte');
